...
export async function POST(request: Request) {
  try {
    ...
    const parsed = createQuoteBodySchema.safeParse({
      ...
      logoComposition: formData.get('logoComposition') || '',
      logoText: formData.get('logoText') || '',
      logoIcon: formData.get('logoIcon') || '',
      logoColorSource: formData.get('logoColorSource') || '',
      logoPrimaryColor: formData.get('logoPrimaryColor') || '',
      logoSecondaryColor: formData.get('logoSecondaryColor') || '',
      logoAlternateColor: formData.get('logoAlternateColor') || '',
      logoVibe: formData.get('logoVibe') || '',
      logoNotes: formData.get('logoNotes') || '',
    ...
    const { prompt, payload, profile } = await buildPromptFromQuoteWithKnowledge({
      ...
      logoComposition: data.logoComposition || '',
      logoText: data.logoText || '',
      logoIcon: data.logoIcon || '',
      logoColorSource: data.logoColorSource || '',
      logoPrimaryColor: data.logoPrimaryColor || '',
      logoSecondaryColor: data.logoSecondaryColor || '',
      logoAlternateColor: data.logoAlternateColor || '',
      logoVibe: data.logoVibe || '',
      logoNotes: data.logoNotes || '',
    });
